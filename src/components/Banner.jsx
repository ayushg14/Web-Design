    ...
    <div className="bg-black text-white pb-16">
      <div className="flex items-center border-b-[0.5px] border-white max-md:flex-col">
        <div className="w-1/2 border-r-[0.5px] border-white h-full ml-4 max-md:w-auto">
          <h1 className="text-8xl w-3/4 p-8 max-md:text-[5rem] kuenstler">
        ...
        <div className="w-1/2 p-8 max-md:w-auto">
          <img
            ...
            alt="user-experience"
          />
          <p className="text-lg w-4/5 kuenstler">
          ...
          <h4 className="text-xl mt-6 kuenstler">Jackie Colburn</h4>
        </div>
      </div>

      {/* Second Container */}
      <div className="mt-12">
        <h1 className="text-8xl flex m-auto text-center w-4/5 max-md:text-7xl max-md:text-left kuenstler">
          Create the space for your thinking to take off.
        </h1>
        <p className="text-md w-1/2 text-center m-auto mt-12 max-md:w-[74%] kuenstler">
        ...
        <div className="flex justify-center">
          <button className="btn border border-green-400 text-green-400 rounded-2xl p-2 pl-8 pr-8 mt-8 kuenstler">
            Write on Medium
          </button>
        </div>
      </div>
